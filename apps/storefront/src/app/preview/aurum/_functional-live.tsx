            ...
            <div className={s.checkoutForm}>
              ...
              <div className={s.formBlock} id="aurum-address-section">
                ...
                <form action={setAddressAction} className={s.formGrid}>
                  ...
                  <div className={`${s.formGroup} ${s.formGroupFull}`}><label className={s.formLabel}>Landmark (optional)</label><input name="company" className={s.formInput} defaultValue={addr?.company ?? ""} placeholder="e.g. near Laxma Reddy shop" /></div>
