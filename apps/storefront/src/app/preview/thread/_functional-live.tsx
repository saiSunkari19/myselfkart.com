            ...
            <div className={s.checkoutForm}>
              ...
              <div className={s.formSection} id="thread-address-section">
                ...
                <form action={setAddressAction} className={s.formGrid}>
                  ...
                  <div className={s.formGroup} style={{ gridColumn: "1 / -1" }}><label className={s.formLabel}>Address line 1</label><input name="address_1" className={s.formInput} defaultValue={addr?.address_1 ?? ""} placeholder="House / flat no., building, street" required /></div>
                  <div className={s.formGroup} style={{ gridColumn: "1 / -1" }}><label className={s.formLabel}>Address line 2 (optional)</label><input name="address_2" className={s.formInput} defaultValue={addr?.address_2 ?? ""} placeholder="Area, locality" /></div>
                  <div className={s.formGroup} style={{ gridColumn: "1 / -1" }}><label className={s.formLabel}>Landmark (optional)</label><input name="company" className={s.formInput} defaultValue={addr?.company ?? ""} placeholder="e.g. near Laxma Reddy shop" /></div>
