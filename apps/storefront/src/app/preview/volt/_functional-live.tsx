  ...
  const addressForm = (
    <>
      ...
      <form action={setAddressAction} className={s.formGrid}>
        ...
        <div className={`${s.formGroup} ${s.formGroupFull}`}><label className={s.formLabel}>Area / Locality / Landmark</label><input name="address_2" className={s.formInput} defaultValue={addr?.address_2 ?? ""} placeholder="Optional — area, locality or a nearby landmark (helps delivery)" /></div>
