...
test("admin notifications are isolated by tenant", () => {
  medusaExec("./src/scripts/seed-tenants.ts")
  medusaExec("./src/scripts/seed-tenant-notifications.ts", {
    SELLER_ADMIN_TENANT_ID: TENANT_A,
  })
  medusaExec("./src/scripts/seed-tenant-notifications.ts", {
    SELLER_ADMIN_TENANT_ID: TENANT_B,
  })
  medusaExec("./src/scripts/assert-notification-isolation.ts")
})
